...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Alan Developer</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1 bg-danger py-3 px-0 px-lg-3 rounded"><%=session.getAttribute("name") %></li>
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Alan Developer</h1>
			<!-- Icon Divider-->
			...
			<p class="masthead-subheading font-weight-light mb-0">Java
				Development - Web Development - DevOps Development</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<p class="lead mb-0">
						Freelance is a free to use, MIT licensed Theme created
						by <a href="https://www.linkedin.com/in/alanraju/">Alan Raju</a> .
					</p>
				</div>
			</div>
		</div>
